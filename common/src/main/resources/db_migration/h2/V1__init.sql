...
(
    id            BIGINT NOT NULL DEFAULT NEXT VALUE FOR computer_attribute_type_seq,
...
(
    id           BIGINT NOT NULL DEFAULT NEXT VALUE FOR computer_seq,
    name         VARCHAR(50),
    date_created TIMESTAMP NOT NULL,
    voided       BOOLEAN,
    date_updated TIMESTAMP,
...
(
    id             BIGINT NOT NULL DEFAULT NEXT VALUE FOR consumer_seq,
...
(
    id                 BIGINT NOT NULL DEFAULT NEXT VALUE FOR cpu_seq,
...
(
    id                  BIGINT NOT NULL DEFAULT NEXT VALUE FOR generic_component_seq,
    manufacturer        VARCHAR(50),
    model               VARCHAR(50),
    year_released       INTEGER,
    is_discontinued     BOOLEAN,
...
(
    id                 BIGINT NOT NULL DEFAULT NEXT VALUE FOR gpu_seq,
    manufacturer       VARCHAR(50),
    model              VARCHAR(50),
    year_released      INTEGER,
    is_discontinued    BOOLEAN,
...
(
    id                 BIGINT NOT NULL DEFAULT NEXT VALUE FOR memory_module_seq,
    manufacturer       VARCHAR(50),
    model              VARCHAR(50),
    year_released      INTEGER,
    is_discontinued    BOOLEAN,
...
(
    id                 BIGINT NOT NULL DEFAULT NEXT VALUE FOR network_device_seq,
    manufacturer       VARCHAR(50),
    model              VARCHAR(50),
    year_released      INTEGER,
    is_discontinued    BOOLEAN,
...
(
    id             BIGINT NOT NULL DEFAULT NEXT VALUE FOR nonce_seq,
    name           VARCHAR(50),
    date_created   TIMESTAMP NOT NULL,
    voided         BOOLEAN,
    date_updated   TIMESTAMP,
...
(
    id             BIGINT NOT NULL DEFAULT NEXT VALUE FOR provider_seq,
    username       VARCHAR(255)                NOT NULL,
    role           VARCHAR(255),
    name           VARCHAR(50),
    date_created   TIMESTAMP NOT NULL,
...
(
    id                 BIGINT NOT NULL DEFAULT NEXT VALUE FOR storage_seq,
    manufacturer       VARCHAR(50),
    model              VARCHAR(50),
    year_released      INTEGER,
    is_discontinued    BOOLEAN,
...
(
    id                              BIGINT NOT NULL DEFAULT NEXT VALUE FOR benchmark_report_seq,
    date_created                    TIMESTAMP NOT NULL,
    description                     VARCHAR(255),
    elapsed_time                    BIGINT,
    uuid                            VARCHAR(38)                 NOT NULL,
