...
public class SecurityService {
    ...
    public void example() {
        ...
        try {
            // 1. Generate a Kyber key pair and extract Public and Private keys using 1024-bit Kyber
            ...
            // 2. Encapsulation (sender side): Sender only has the public key
            ...
            System.out.println(" => Encryption key == Decryption key? " + Arrays.equals(encryptionKey, decryptionKey));

            // 7. Decrypt data using the AES key
